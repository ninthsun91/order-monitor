...
| M5 | Watchdog + 배포 | 🟡 진행 중 | (구현 완료 2026-07-15, 7일 무인 운영 검증 대기) |
...
- VPS 배포 + 행 훈련(`kill -STOP` → PROCESS_DOWN → 자동 재시작 → 해소 통지) + 7일 무인 운영 검증 — **미실시, 배포 세션에서 진행** (RUNBOOK §4 설치 순서 주의: 서비스 유닛 먼저, 타이머 나중)
